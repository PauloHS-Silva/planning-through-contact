...
from .. import (
    drake_gcs_to_nx_graph_of_drake_prog,
...
class TestDrakeGcsToNxGraphOfDrakeProg(unittest.TestCase):
    def test_via_round_trip_and_solve(self):
        ...
        result = drake_gcs.SolveShortestPath(drake_source, drake_target, drake_options)

        nx_gcs = (
            drake_gcs_to_nx_graph_of_drake_prog.drake_gcs_to_nx_graph_of_drake_prog(
                drake_gcs
            )
        )
        ...
        gcs_solver_gcs, nx_gcs_to_gcs_solver = (
